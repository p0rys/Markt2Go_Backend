...
namespace Markt2Go.Migrations
{
    ...
    [Migration("20200327201646_Reservation_UserIdAsString")]
    partial class Reservation_UserIdAsString
    {
            ...
            modelBuilder.Entity("Markt2Go.Models.Reservation", b =>
                {
                    ...
                    b.Property<long>("MarketSellerMarketId")
                        .HasColumnType("bigint");

                    b.Property<long>("MarketSellerSellerId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MarketSellerSellerId", "MarketSellerMarketId");
            ...
            modelBuilder.Entity("Markt2Go.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("Markt2Go.Models.MarketSeller", "MarketSeller")
                        .WithMany()
                        .HasForeignKey("MarketSellerSellerId", "MarketSellerMarketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
